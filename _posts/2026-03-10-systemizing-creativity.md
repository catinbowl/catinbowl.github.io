...
author: Muhammad Fauzan Azmi Arzaki
...
By structuring our CSS and our component hierarchy to reflect the mental models of both the designer and the engineer, we dramatically reduce the friction of _Design-to-Code_ bridging. We end up with codebases that are maintainable, performant, and, above all, delightful for our users.
